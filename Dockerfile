...
ARG IMAGE_COMPONENT="validation-operator-container"
ARG IMAGE_NAME="validation-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Validation Operator"
ARG IMAGE_DESC="This image includes the validation-operator"
...
ENV USER_UID=$USER_ID \
    OPERATOR_TEMPLATES=/usr/share/validation-operator/templates/ \
